...
function SettingsSidebar() {
  return (
    <div className="bg-black">
        <div className="absolute top-20 left-0 pl-3 pt-3 overflow-scroll h-full scrollbar-hide flex flex-col m-w-20 bg-black">
            <h2 className="font-bold text-2xl">General Settings</h2>

            <div className="flex items-center font-semibold pt-5 pl-0">
